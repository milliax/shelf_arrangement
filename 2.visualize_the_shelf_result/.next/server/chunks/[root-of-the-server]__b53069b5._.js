module.exports = [
"[project]/.next-internal/server/app/api/optimization-runs/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
async function yl(e, r) {
    ...
    let o = await ir(), s = r.generator?.binaryTargets ?? [], a = s.some((d)=>d.native), l = !s.some((d)=>d.value === o), u = ("TURBOPACK compile-time value", "/ROOT/generated/prisma/runtime/library.js").match(nf()) === null, c = {
        searchedLocations: i,
...
async function of(e, r) {
    let t = await ir(), n = [], i = [
        r.dirname,
        Tt.default.resolve(("TURBOPACK compile-time value", "/ROOT/generated/prisma/runtime"), ".."),
        r.generator?.output?.value ?? ("TURBOPACK compile-time value", "/ROOT/generated/prisma/runtime"),
        Tt.default.resolve(("TURBOPACK compile-time value", "/ROOT/generated/prisma/runtime"), "../../../.prisma/client"),
        "/tmp/prisma-engines",
        r.cwd
    ];
    ("TURBOPACK compile-time value", "/ROOT/generated/prisma/runtime/library.js").includes("resolveEnginePath") && i.push(fs());
    for (let o of i){
 ...
 */ const config = {
    ...
    "inlineSchemaHash": "d6c4904dc27a720e3490bca27b3ec65c24b14237634a83f98d4418719dd845d2",
    "copyEngine": true
};
...
;
const prisma = globalThis.prisma ?? new __TURBOPACK__imported__module__$5b$project$5d2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PrismaClient"]({
    log: [
        'query'
    ]
});
...
"[project]/src/app/api/optimization-runs/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        const runs = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].optimization_runs.findMany({
            orderBy: {
                created_at: 'desc'
            }
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(runs);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b53069b5._.js.map